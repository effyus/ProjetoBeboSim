    ...
    form.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            if (response.ok) {
                ...
                window.location.href = '/assets/pages/agendamento/buscar.html';
            } else {
                alert('Erro ao cadastrar agendamento: ' + (data.message || data.error || 'Erro desconhecido'));
            }
        } catch (error) {
            console.error('Erro:', error);
            alert('Erro ao cadastrar agendamento. Por favor, tente novamente.');
        }
    });
